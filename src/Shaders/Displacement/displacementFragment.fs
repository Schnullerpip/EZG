...
uniform float numLayersRefinement;
...
{ 
	...
	depthStep = 1.0 / numLayersRefinement;
    float beforeDepth = texture(depthMap, prevTexCoords).r - currentLayerDepth + depthStep;
	currentLayerDepth = beforeDepth;
    deltaTexCoords = P / numLayersRefinement;
